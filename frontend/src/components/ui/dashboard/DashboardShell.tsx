...
export function DashboardShell({ children }: DashboardShellProps) {
  ...
  return (
    <div className="grid min-h-screen w-full md:grid-cols-[240px_1fr] lg:grid-cols-[280px_1fr]">
      <div className="border-r border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/50 hidden md:flex md:flex-col">
      ...
      <div className="flex flex-col">
        <header className="flex h-16 items-center border-b border-gray-200 dark:border-gray-800 px-6">
          <nav className="flex items-center gap-4 md:gap-6 text-sm md:hidden">
            {/* Mobile navigation */}
